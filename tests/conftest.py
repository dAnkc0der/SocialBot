...
# SQLALCHEMY_DATABASE_URL = 'postgresql://postgres:admin123@localhost:5432/fastapi_test'
...
def test_user2(client):
    user_data = {"email" : "bruhji@gmail.com", "password" : "password123"}
...
def test_user(client):
    user_data = {"email" : "bruh@gmail.com", "password" : "password123"}
    res = client.post("/users/", json=user_data)
    assert res.status_code == 201  
    print(res.json())
    new_user = res.json()
